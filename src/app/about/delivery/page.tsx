            ...
            <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
                <div className="max-w-[1536px] mx-auto px-4 flex gap-6">
                    <div className="flex-1">
                        ...
                        <div
                            className="bg-white dark:bg-gray-800 rounded-xl p-6 border flex flex-col lg:flex-row gap-6 items-center">
                            ...
                            <div className="flex-1">
                                ...
                                <div className="flex gap-3">
                                    ...
                                    <Link
                                        href="/catalog"
                                        className="border px-5 py-2 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700 transition"
                                    >
                                        Смотреть каталог
                                    </Link>
                                </div>
